package
{
	...
	import com.examples.DataGridExample;
	...
	public class Main extends Sprite
	{
		...
		private function loaderInfo_completeHandler(event:Event):void
		{
			...
			removeEventListener(Event.ADDED_TO_STAGE, loaderInfo_completeHandler);
			Starling.multitouchEnabled = true;
			this._starling = new Starling(DataGridExample, this.stage, null, null, Context3DRenderMode.AUTO, Context3DProfile.BASELINE);
